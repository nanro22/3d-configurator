 ...
 * Tue Aug 25 2020 17:15:40 GMT+0200 (heure d’été d’Europe centrale)
...
eventHTMLElem('click', 'button_material_1', true, function(event) {
  assignMat(['GROUP', 'lamp2'], 'peinture brillan');
  assignMat(['GROUP', 'lamp1'], 'peinture brillan');
  assignMat(['GROUP', 'lamp3'], 'peinture brillan');
});
eventHTMLElem('click', 'button_material_2', true, function(event) {
  assignMat(['GROUP', 'lamp2'], 'peinture brillan.001');
  assignMat(['GROUP', 'lamp3'], 'peinture brillan.001');
  assignMat(['GROUP', 'lamp1'], 'peinture brillan.001');
});
eventHTMLElem('click', 'button_material_3', true, function(event) {
  assignMat(['GROUP', 'lamp2'], 'peinture brillan.002');
  assignMat(['GROUP', 'lamp1'], 'peinture brillan.002');
  assignMat(['GROUP', 'lamp3'], 'peinture brillan.002');
});
